      ...
      <div id="registo">
        ...
        <div id="formulario">
            <form class="register" method="post">
                Hostname: <input type="text" name="hostname" maxlength="150" size="100" />
                <br/>
                Url: <input type="text" name="site" maxlength="1000" size = "100"/>
                <br/>
                Tags: <input type="text" name="titulo" maxlength="150" size="100"/>
                <br/>
				...
				<br />
				<br />
                <input class="button_r" type="submit" value="Importar" onclick="receiveJSON(site,titulo,init,final);return false">
            </form>
